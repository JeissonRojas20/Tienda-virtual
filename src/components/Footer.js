...
const Footer = () => {
    ...
    return (
        ...
        <footer className="bg-orange-200 from-slate-900 via-slate-700 to-slate-900 py-10 px-10 font-sans tracking-wide">
            <div className="max-w-2xl mx-auto text-center">
                <a href="javascript:void(0)" className="inline-block "><img src="https://i.imgur.com/xtHlFoO.png" alt="logo" className="w-48 rounded" /></a>
                <p className="text-sm mt-8 text-gray-800">Si te gustaron los productos y deseas apoyarnos en nuestras redes sociales, en la parte inferior estaran los links de la cuenta.</p>
